...
module.exports = {
    ...
    login: async (req, res) => {
        /*
            ...
            _swagger.deprecated = true         ----> başında çizgi değil kare var gene ama algılanmasın diye böle. üstünüğ çiziyor ve aktif değil diyor
        ...
        */
        ...
        if (refreshToken) {
            ...
            if (jwtData) {
                ...
                const checkUser = await checkUserAndSetToken(jwtData, false)  //----> false'u refresh  token istemedeğimizden yazıyorum
                if (checkUser.error) {
                    res.errorStatusCode = 401
                    throw new Error(checkUser.message)
                } else {
